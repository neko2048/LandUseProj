...
"tiley": 2400,
"colorMap": {
    1:  ["#005243", "Evergreen Needleleaf"], 
    2:  ["#007b43", "Evergreen Broadleaf"], 
    3:  ["#00552e", "Deciuous Needleleaf"], 
    4:  ["#028760", "Deciuous Broadleaf"], 
    5:  ["#006e54", "Mixed Forests"], 
    6:  ["#69b076", "Closed Shrublands"], 
    7:  ["#7ebeab", "Open Shrublands"], 
    8:  ["#3eb370", "Woody Savannas"], 
    9:  ["#a6c8b2", "Savannas"], 
    10: ["#98d98e", "Grasslands"], 
    ...
    17: ["#54aaea", "Water"], 
    18: ["#47885e", "Wooded Tundra"], 
    19: ["#93ca76", "Mixed Tundra"], 
...
"colorMap": {
     1: ["#e21417", "urban"], 
     2: ["#ffea00", "dryland"], 
     3: ["#f8b500", "irrigated cropland"], 
     4: ["#fabf14", "mixed dryland/irrigated"], 
     5: ["#ffd900", "cropland/grassland"], 
     6: ["#fbd26b", "cropland/woodland"], 
     7: ["#98d98e", "grassland"], 
     8: ["#69b076", "shrubland"], 
     9: ["#7ebeab", "mixed shrubland/grassland"], 
    10: ["#a6c8b2", "savanna"], 
    11: ["#007b43", "deciduous broadleaf"], 
    12: ["#00552e", "deciduous needleleaf"], 
    13: ["#028760", "evergreen broadleaf"], 
    14: ["#005243", "evergreen needleleaf"], 
    15: ["#006e54", "mixed forest"], 
    16: ["#54aaea", "water bodies"], 
    17: ["#946243", "herbaceous wetland"], 
    18: ["#316745", "wooden wetland"], 
    19: ["#f6ad49", "barren or sparsely vegetated"], 
    }
}
